<template>
  <div id="container">
    ...
    <div class="header-text" style="margin: 50px">
      <h1 style="margin: 0; font-family: Radicalis;">What The Flag Could Be</h1>
      <p style="margin: 0">New Jersey needs a memorable design that represents our shared history, values and geography.</p>
    </div>
    <div class="card">
